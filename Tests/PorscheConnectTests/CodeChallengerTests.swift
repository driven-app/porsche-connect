...
final class CodeChallengerTests: XCTestCase {
  ...
  func testCodeChallenge() {
    ...
    XCTAssertEqual(
      "dADBvw4mcionJ5slawFhCxPFdHKdZ5naQri71Dq8OxA",
      codeChallenger.codeChallenge(for: "R9TKdFZFg6vSg1fBA1sckttPmbVEiPLoNjDZIGFozC8FETVzayig")!)
    XCTAssertEqual(
      "Tsnu08fmm7D9XIx_XZnfub_QX0qDoQno4q7eRj7dHgw",
      codeChallenger.codeChallenge(for: "QtT30VN5sy2HjI8nooey8qLPuuRuOg32KJEg2bRpSVe6DFEPe6lDw")!)
  }
